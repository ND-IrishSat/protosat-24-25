...
Author: Juwan Jacobe
    ...
    This script reads data from MPU9250 board and solves
    for the hard iron offset for a magnetometer using a calibration
    block
'''
...
def mag_cal():
    ...
    print(len(mag_cal_rotation_vec[0]))
    print(len(mag_cal_rotation_vec[1]))
    print(len(mag_cal_rotation_vec[2]))    
